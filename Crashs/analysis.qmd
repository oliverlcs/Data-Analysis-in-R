...
**Ergebnis:** Besonders hohe Unfallhäufigkeiten treten im Bereich zwischen den Längengraden -77,3 und -76,9 sowie den Breitengraden 38,95 und 39,2 auf, was auf die urbaneren Bereiche des Countys hindeutet. Die räumliche Verteilung schwerer Unfälle ähnelt dabei weitgehend der allgemeinen Unfallverteilung, ist jedoch etwas breiter gestreut, was darauf schließt, dass schwere Unfälle nicht ausschließlich in den größten Unfallhotspots auftreten.

**Vergleich mit Hypothese:** ⚠️ **Nicht vollständig testbar** — Da keine detaillierten geografischen Informationen zu Hauptverkehrsachsen, Knotenpunkten oder Schnellstraßen vorlagen, konnte die Hypothese, dass sich Unfälle gezielt an diesen Orten konzentrieren, nicht eindeutig überprüft werden. Auf Basis der räumlichen Analyse konnten jedoch potenzielle Hotspots identifiziert werden, die vermutlich stark frequentierte Verkehrsbereiche abbilden.
...
**Vergleich mit Hypothese:** ✅ **Vollständig bestätigt** — Wie vermutet weisen Motorrad- und Mopedfahrer den höchsten Anteil schwerer Verletzungen auf, was sich durch den fehlenden Karosserieschutz erklären lässt. Ebenso bestätigt sich die Annahme, dass eine geringere Ortskenntnis mit einer höheren Schuldquote einhergeht.
