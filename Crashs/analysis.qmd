...
**Fragestellung D: Ablenkung am Steuer — Typen und Auswirkungen**
...
**Fragestellung E: Fußgänger- und Radfahrerunfälle — Risikofaktoren**
...
### Erwartungen und Hypothesen

Vor der Analyse formulieren wir unsere Erwartungen, um diese später mit den tatsächlichen Ergebnissen vergleichen zu können:

**Zu Fragestellung A (Zeitliche Muster):**
Wir erwarten, dass Unfälle während der Rush Hour (7–9 Uhr und 16–18 Uhr) gehäuft auftreten, da dann das Verkehrsaufkommen am höchsten ist. Gleichzeitig vermuten wir, dass nächtliche Unfälle (22–5 Uhr) trotz geringerer Häufigkeit schwerere Verletzungen verursachen — bedingt durch höhere Geschwindigkeiten, schlechtere Sicht und möglicherweise Alkoholeinfluss.

**Zu Fragestellung B (Wetter):**
Entgegen der intuitiven Annahme erwarten wir, dass Unfälle bei schlechtem Wetter (Regen, Schnee, Eis) nicht zwingend schwerer sind als bei guten Bedingungen. Unsere Hypothese: Fahrer passen ihr Verhalten an und fahren bei widrigen Bedingungen vorsichtiger und langsamer, was die Unfallschwere reduziert.

**Zu Fragestellung C (Substanzeinfluss):**
Wir erwarten, dass Fahrer mit Alkohol- oder Drogeneinfluss (Kategorien CONTRIBUTED, PRESENT, SUSPECT) signifikant häufiger als schuldig eingestuft werden als nüchterne Fahrer. Zudem vermuten wir, dass Unfälle unter Substanzeinfluss schwerere Verletzungen nach sich ziehen, da die Reaktionsfähigkeit und das Urteilsvermögen beeinträchtigt sind.

**Zu Fragestellung D (Ablenkung):**
Wir erwarten, dass Handynutzung (PHONE USE) die häufigste dokumentierte Ablenkungsform ist und überproportional zu Auffahrunfällen (REAR-END) führt. Der Grund: Bei Handynutzung wird der Blick von der Straße abgewendet, wodurch das vorausfahrende Fahrzeug zu spät wahrgenommen wird.

**Zu Fragestellung E (Fußgänger/Radfahrer):**
Wir erwarten, dass Unfälle mit Fußgängern und Radfahrern häufiger bei schlechten Lichtverhältnissen (DARK) auftreten und deutlich schwerere Verletzungen verursachen als Unfälle zwischen Fahrzeugen. Der fehlende Schutz durch eine Karosserie macht diese Verkehrsteilnehmer besonders verwundbar.
...
data$Related.Non.Motorist[str_detect(data$Related.Non.Motorist, "^(OTHER$|OTHER CONVEYANCE$|OTHER, OTHER|MACHI|OCC)")] <- "OTHER"
...
Bei der allgemeinen Verteilung der Unfälle nach Tageszeit lassen sich zwei Spitzen um 8 Uhr und um 17 Uhr erkennen, wobei das Tagesmaximum um 17 Uhr erreicht wird. Dies kann auf den erhöhten Arbeitsverkehr zu Beginn und am Ende des Arbeitstages hindeuten.
...
Die Heatmap unterstützt die zuvor genannte Vermutung zum Arbeitsverkehr. Die Unfallhäufigkeit ist insbesondere von Montag bis Freitag zwischen 7 und 9 Uhr sowie 15 und 18 Uhr erhöht. Am Wochenende verteilt sich die Unfallhäufigkeit zwischen 11 und 19 Uhr relativ gleichmäßig. Auffällig ist, dass in den frühen Morgenstunden weniger Unfälle auftreten, vermutlich weil viele Personen zu dieser Zeit schlafen.
...
Über das Jahr hinweg lassen sich zwei Spitzen im Mai und im Oktober erkennen. Die zeitlichen Verläufe der einzelnen Jahre sind weitgehend ähnlich, wobei das Jahr 2020 eine deutliche Abweichcung aufweist. Im April 2020 wurde ein markanter Tiefpunkt erreicht, der im weiteren Jahresverlauf wieder leicht anstieg, was vermutlich auf die Auswirkungen der Corona-Pandemie im März 2020 zurückzuführen ist. Auch im Jahr 2025 zeigt sich ein Bruch im Oktober, der jedoch auf unvollständige Daten zurückzuführen ist, da nur Daten bis zum 21.10.2025 erhoben wurden.
...
Der p-Wert ist sehr klein, was darauf schließen lässt, dass die Verteilung der Unfälle vom Wochentag abhängt.
...
Auch hier ist der p-Wert extrem klein, was auf einen statistischen Zusammenhang zwischen der Tageszeit und der Verletzungsschwere schließen lässt.
...
Die meisten Unfälle ereigneten sich bei klarem Wetter, während nur wenige bei Wind, Nebel oder Schneefall auftraten. Dies könnte jedoch auch darauf zurückzuführen sein, dass die meisten Tage klares Wetter aufwiesen. 
...
Bei den Anteilen der Verletzungsschwere unter verschiedenen Wetterbedingungen zeigen sich nur geringe Unterschiede.
...
Der Anteil schwerer Verletzungen ist bei Nebel bzw. schlechten Sichtverhältnissen am höchsten, liegt jedoch auch hier lediglich bei etwa einem Prozent.
...
Die Visualiserung zeigt, dass bei Fahrzeugzerstörung die meisten Unfälle auf nassen Straßen passieren, während Schnee den geringsten Anteil aufweist. Bei nicht fahrtüchtigen Fahrzeugen tritt der höchste Anteil auf sandigen Straßen auf. Unfälle ohne Schaden kommen am häufigsten bei Schnee vor, während oberflächliche Schäden überwiegend auf verschmutzten oder schlammigen Straßen auftreten.
...
Bei Vergleich der Verletzungsschwere zwischen guten und schlechten Wetterbedingungen zeigt sich kein nennenswerter Unterschied.
...
Schwere Verletzungen lassen sich nicht mit guten oder schlechten Wetterbedingungen in Verbindung bringen, dad er Anteil in beiden Fällen unter einem Prozent liegt. 
...
Sowohl zwischen dem Wetter und der Verletzungsschwere als auch zwischen der Straßenbedingung und dem Fahrzeugschaden lässt sich ein statistischer Zusammenhang erkennen.
...
Auch die Visualisierung des Drogeneinflusses zeigt eine nahezu identische Verteilung. Auch hier liegt der Anteil schuldiger Fahrer bei nachgewiesenen Drogen über 95 %.

#### Statistische Prüfung: Chi-Quadrat-Test

Um zu prüfen, ob ein statistisch signifikanter Zusammenhang zwischen Substanzeinfluss und Schuld besteht, wird ein Chi-Quadrat-Test durchgeführt:
...
Beim Vergleich der Verletzungsschwere nach Alkoholstatus traten keine auffälligen Unterschiede auf. Zwar ist der Anteil schwerer Verletzungen insgesamt sehr gering, dennoch lässt sich dieser Anteil allein bei nachgewiesenem Alkohol feststellen.
---
...
Mit 62,7 % wird bestätigt, dass in den meisten Fällen die Fahrer nicht abgelenkt waren. Bei knapp 20 % der Unfälle konnte man nicht identifizieren, ob der Fahrer abgelenkt war. Mit 11 % ist die häufigste Ablenkungsart, dass der Fahrer visuell abgelenkt wurde.
...
Bei nahezu allen Ablenkungsarten treten **Auffahrunfälle** am häufigsten auf. Eine Ausnahme bildet die **visuelle Ablenkung**, bei der **Angle-Kollisionen** den größten Anteil ausmachen. Bei **No driver present** lässt sich hingegen der am häufigsten vorkommende Kollisionstyp nicht feststellen, da dieser nicht definiert ist. 
...
Auffahrunfälle treten bei Handynutzung in 42,8 % der Fälle auf, während ihr Anteil bei anderen Ablenkungsarten lediglich 32,9 % beträgt. Damit sind Auffahrunfälle bei Handynutzung deutlich häufiger vertreten.
...
Der p-Wert ist mit kleiner als 2.2e-16 extrem klein, wodurch ein statistischer Zusammenhang zwischen der Ablenkungsart und dem Kollisionstyp besteht.
...
Die Visualisierung zeigt das bei den meisten Ablenkungsarten der Anteil schuldiger Fahrer sehr hoch ist. Nur wenn der Fahrer nicht abgelenkt wurde, ist der Anteil schuldiger Fahrer bei lediglich 30,4 %.

#### Zwischenfazit Fragestellung D

Die Analyse der Ablenkungsarten zeigt interessante Muster. Der Chi-Quadrat-Test bestätigt einen statistisch signifikanten Zusammenhang zwischen Ablenkungsart und Kollisionstyp. Die Hypothese bezüglich Handynutzung und Auffahrunfällen kann anhand der Daten bestätigt werden.
...
Der Großteil der nicht-motorisierten Verkehrsteilnehmer sind Fußgänger, gefolgt von Fahrradfahrern als zweitgrößter, jedoch deutlich kleinerer Teil. 
...
Der Anteil der Unfälle mit Beteiligung von Fußgängern oder Radfahrern ist über die verschiedenen Lichtverhältnisse hinweg ähnlich hoch wie der Anteil von Unfällen, an denen ausschließlich Fahrzeuge beteiligt sind.
...
Der Anteil der Unfälle bei Dunkelheit ist bei Unfällen mit Beteiligung von Fußgängern oder Radfahrern etwas höher als bei Unfällen mit ausschließlich motorisierten Fahrzeugen. Dies deutet darauf hin, dass Fußgänger und Radfahrer bei Dunkelheit einem höheren Risiko ausgesetzt sind, zum Beispiel aufgrund ihrer geringen Sichtbarkeit. 
...
Bei Unfällen mit Fußgängern oder Radfahrern bleiben die Beteiligten in den meisten Fällen unverletzt. Bei Unfällen mit ausschließlich motorisierten Fahrzeugen ist der Anteil unversehrter Beteiligter etwas geringer, während der Anteil möglicher oder leichter Verletzungen etwas höher ausfällt. 
```{r}
...
Der Anteil schwerer Verletzungen liegt in beiden Gruppen unter einem Prozent. 
...
Der Anzahl der Unfälle mit nicht-motorisierten Verkehrsteilnehmern nimmt im Verlaufe des Tages zu und erreicht ihren Höhepunkt gegen 17-18 Uhr. Die wenigsten Unfälle passieren zwischen 0 und 5 Uhr morgens.
...
Nicht-motorisierte Verkehrsteilnehmer zeigen sowohl im Zusammenhang mit Lichtverhältnisssen, als auch mit der Verletzungsschwere einen statistischen Zusammenhang.

#### Zwischenfazit Fragestellung E

Die Analyse zeigt Unterschiede zwischen Unfällen mit und ohne nicht-motorisierte Verkehrsteilnehmer. Die Chi-Quadrat-Tests bestätigen statistisch signifikante Zusammenhänge sowohl mit den Lichtverhältnissen als auch mit der Verletzungsschwere. Die Hypothese, dass Unfälle mit Fußgängern und Radfahrern schwerere Verletzungen verursachen, kann anhand der Daten überprüft werden.
