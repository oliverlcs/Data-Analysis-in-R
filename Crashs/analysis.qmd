...
Besonders interessant ist die Möglichkeit, menschliche Verhaltensfaktoren wie Alkohol- und Drogeneinfluss, Ablenkung am Steuer sowie die Interaktion mit vulnerablen Verkehrsteilnehmern zu untersuchen.
...
**Nächtliche Unfallschwere:** Die Hypothese, dass nächtliche Unfälle trotz geringerer Häufigkeit schwerere Verletzungen verursachen, wird durch die Daten gestützt. Der Anteil schwerer Verletzungen (FATAL + SUSPECTED SERIOUS INJURY) liegt nachts (20–6 Uhr) bei 1,15 % gegenüber 0,83 % am Morgen, 0,78 % am Mittag und 0,68 % am Abend. Der Chi-Quadrat-Test (p < 2.2e-16) bestätigt diesen Zusammenhang statistisch.
...
Beide Tests ergeben extrem niedrige p-Werte (p = 1,59e-09 für Lichtverhältnisse bzw. p < 2,2e-16 für Verletzungsschwere). Damit kann die Nullhypothese der Unabhängigkeit in beiden Fällen klar verworfen werden. Es besteht somit ein statistisch signifikanter Zusammenhang zwischen der Beteiligung nicht-motorisierter Verkehrsteilnehmer und sowohl den Lichtverhältnissen als auch der Verletzungsschwere.
...
**Vergleich mit Hypothese:** Die Vermutung lautete, dass schlechtes Wetter nicht zwangsläufig zu schwereren Unfällen führt, weil Fahrer ihr Verhalten anpassen. Das bestätigen die Daten: Bei Regen, Schnee oder Eis sinkt die Unfallschwere, was auf vorsichtigeres Fahren hindeutet.
...
**Vergleich mit Hypothese:** Erwartet hatten wir, dass Fahrer unter Substanzeinfluss häufiger als schuldig eingestuft werden und dass solche Unfälle schwerer ausfallen. Beides zeigt sich deutlich in den Daten: Sowohl die Schuldquote als auch die Verletzungsschwere liegen bei Alkohol- oder Drogeneinfluss klar über dem Durchschnitt.
