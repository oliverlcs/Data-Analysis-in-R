...
Einzigartigkeit einer ID: n_distinct(df\$id) nrow(df) Duplikate finden: df %\>% janitor::get_dupes(id) NA-Anteil pro Spalte: colSums(is.na(df)) \## 3. Bearbeiten/Transformieren der Daten
